...
public class BoardAdminRepositoryTest {
    ...
    @Test
    public void tsetInsert() {  // 테이블 내용 만들기
    ...
    public void testPaging(){
        Pageable pageable = PageRequest.of(0, 10, Sort.by("bano").descending());
    ...
    public void testSearch1(){
        Pageable pageable = PageRequest.of(1, 10, Sort.by("bano").descending());
