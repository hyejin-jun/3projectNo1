...
public class BoardAdminImage implements Comparable<BoardAdminImage>{
    ...
    public int compareTo(BoardAdminImage other) {
        return this.ordba  - other.ordba;   // ???
    }
    public void baChangBoard(BoardAdmin boardAdmin) {this.boardAdmin = boardAdmin;}  // boardAdmin 엔티티 변경시 같이 변경
}
